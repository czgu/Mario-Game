...
//Define all the size for them
    ...
    //========================================================================================================================================
            ...
            rotate_sprite(buffer, Fire_Stand_L, 0,0,itofix(angle));
            rotate_sprite_v_flip(buffer, Fire_Stand_L, angle,200,itofix(angle));
            pivot_sprite(buffer, Fire_Stand_L, angle,100, 12, 12,itofix(angle));
            //score------------------------------------------------------------------------------------------------------------------------------------------------
            for(i=0;i<1000;i++)
            {
                if(Gamescore[i].life > 0)
